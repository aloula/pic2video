...
- [ ] TXXX [P] README.md update for usage/build/run/troubleshooting changes
...
- Unit and E2E tests MUST be written and FAIL before implementation
...
Task: "E2E test for [user journey] in tests/e2e/test_[name].py"
